...
#
# Created: Fri Feb 21 19:45:46 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuCurrent = QtGui.QMenu(self.menuSpectrum)
        self.menuCurrent.setObjectName(_fromUtf8("menuCurrent"))
        self.menuPrevious = QtGui.QMenu(self.menuSpectrum)
        self.menuPrevious.setObjectName(_fromUtf8("menuPrevious"))
        self.menuLibrary = QtGui.QMenu(self.menuSpectrum)
        self.menuLibrary.setObjectName(_fromUtf8("menuLibrary"))
        ...
        self.actionIntegrandActiveTrace = QtGui.QAction(MainWindow)
        self.actionIntegrandActiveTrace.setCheckable(True)
        self.actionIntegrandActiveTrace.setChecked(True)
        self.actionIntegrandActiveTrace.setObjectName(_fromUtf8("actionIntegrandActiveTrace"))
        ...
        self.actionIntegrandIndependent = QtGui.QAction(MainWindow)
        self.actionIntegrandIndependent.setCheckable(True)
        self.actionIntegrandIndependent.setObjectName(_fromUtf8("actionIntegrandIndependent"))
        self.actionIntegrandAsFirst = QtGui.QAction(MainWindow)
        self.actionIntegrandAsFirst.setCheckable(True)
        self.actionIntegrandAsFirst.setObjectName(_fromUtf8("actionIntegrandAsFirst"))
        ...
        self.actionSpecMainDisp = QtGui.QAction(MainWindow)
        self.actionSpecMainDisp.setCheckable(True)
        self.actionSpecMainDisp.setChecked(True)
        self.actionSpecMainDisp.setObjectName(_fromUtf8("actionSpecMainDisp"))
        self.actionSpecMainLabel = QtGui.QAction(MainWindow)
        self.actionSpecMainLabel.setCheckable(True)
        self.actionSpecMainLabel.setChecked(True)
        self.actionSpecMainLabel.setObjectName(_fromUtf8("actionSpecMainLabel"))
        self.actionSpecPrevDisp = QtGui.QAction(MainWindow)
        self.actionSpecPrevDisp.setCheckable(True)
        self.actionSpecPrevDisp.setObjectName(_fromUtf8("actionSpecPrevDisp"))
        self.actionSpecPrevLabel = QtGui.QAction(MainWindow)
        self.actionSpecPrevLabel.setCheckable(True)
        self.actionSpecPrevLabel.setObjectName(_fromUtf8("actionSpecPrevLabel"))
        self.actionSpecLibDisp = QtGui.QAction(MainWindow)
        self.actionSpecLibDisp.setCheckable(True)
        self.actionSpecLibDisp.setChecked(True)
        self.actionSpecLibDisp.setObjectName(_fromUtf8("actionSpecLibDisp"))
        self.actionSpecLibLabel = QtGui.QAction(MainWindow)
        self.actionSpecLibLabel.setCheckable(True)
        self.actionSpecLibLabel.setObjectName(_fromUtf8("actionSpecLibLabel"))
        self.actionSpecMainSave = QtGui.QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuPrevious.setTitle(_translate("MainWindow", "Previous", None))
        self.menuLibrary.setTitle(_translate("MainWindow", "Library", None))
        ...
        self.actionIntegrandActiveTrace.setText(_translate("MainWindow", "Active Trace", None))
        self.actionTop_File_Vis_Traces.setText(_translate("MainWindow", "Top File - Vis. Traces", None))
        self.actionIntegrandIndependent.setText(_translate("MainWindow", "Active Run - All Independent", None))
        self.actionIntegrandAsFirst.setText(_translate("MainWindow", "Active Run - All as First", None))
        ...
        self.actionSpecMainDisp.setText(_translate("MainWindow", "Display", None))
        self.actionSpecMainLabel.setText(_translate("MainWindow", "Label", None))
        self.actionSpecPrevDisp.setText(_translate("MainWindow", "Display", None))
        self.actionSpecPrevLabel.setText(_translate("MainWindow", "Label", None))
        self.actionSpecLibDisp.setText(_translate("MainWindow", "Display", None))
