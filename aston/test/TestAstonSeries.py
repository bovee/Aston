...
#TODO: reenable AstonSeries merging someday, but with more intelligence?
#def test_and():
#    t = np.array([1, 2, 3, 4, 5])
#    a = AstonSeries(np.array([10, 20, 30, 40, 50]), t, name='X')
#    b = AstonSeries(np.array([11, 21, 31, 41, 51]), t, name='Y')
...
def test_add():
    t = np.array([1, 2, 3, 4, 5])
    a = AstonSeries(np.array([10, 20, 30, 40, 50]), t, name='X')
    b = AstonSeries(np.array([11, 21, 31, 41, 51]), t, name='X')
    c = a + b
...
def test_compress():
    a = AstonSeries(np.array([10, 20, 30, 40, 50]), \
